...
- Всё создавалось и тестировалось под Ubuntu 20, 22, 24 и Debian 11, 12, 13. Не знаю что насчет других ОС.
...
### Функцианал Up/Down скриптов
- **Up скрипт отвечает за поднятие и добавление правил, а Down скрипт за их остановку и удаление** - Up скрипт запускаеться при старте интерфейса, а Down скрипт при остановке
